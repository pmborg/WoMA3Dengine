...
ID3D11ComputeShader* CTessellator::s_pNumVerticesIndicesCSs[] = { NULL, NULL, NULL, NULL };
...
ID3D11ComputeShader* CTessellator::s_pTessVerticesCSs[] = { NULL, NULL, NULL, NULL };
ID3D11ComputeShader* CTessellator::s_pTessIndicesCSs[] = { NULL, NULL, NULL, NULL };
ID3D11Buffer*        CTessellator::s_pEdgeFactorCSCB = NULL;
ID3D11Buffer*        CTessellator::s_pLookupTableCSCB = NULL;
...
void CTessellator::SetPartitioningMode( PARTITIONING_MODE mode )
{
                                                   ...
                                                   ID3D11ComputeShader** pNumVerticesIndicesCS, ID3D11ComputeShader** pTessVerticesCS, ID3D11ComputeShader** pTessIndicesCS )
{
    ...
    V_RETURN( CompileShaderFromFile( L"TessellatorCS40_NumVerticesIndicesCS.hlsl", define, "CSNumVerticesIndices", "cs_4_0", &pBlobCS ) );
    V_RETURN( m_pd3dDevice->CreateComputeShader( pBlobCS->GetBufferPointer(), pBlobCS->GetBufferSize(), NULL, pNumVerticesIndicesCS ) );
    SAFE_RELEASE( pBlobCS );
    DXUT_SetDebugName( *pNumVerticesIndicesCS, "CSNumVerticesIndices" );

    V_RETURN( CompileShaderFromFile( L"TessellatorCS40_TessellateVerticesCS.hlsl", define, "CSTessellationVertices", "cs_4_0", &pBlobCS ) );
    V_RETURN( m_pd3dDevice->CreateComputeShader( pBlobCS->GetBufferPointer(), pBlobCS->GetBufferSize(), NULL, pTessVerticesCS ) );
    SAFE_RELEASE( pBlobCS );
    DXUT_SetDebugName( *pTessVerticesCS, "CSTessellationVertices" );

    V_RETURN( CompileShaderFromFile( L"TessellatorCS40_TessellateIndicesCS.hlsl", define, "CSTessellationIndices", "cs_4_0", &pBlobCS ) );
    V_RETURN( m_pd3dDevice->CreateComputeShader( pBlobCS->GetBufferPointer(), pBlobCS->GetBufferSize(), NULL, pTessIndicesCS ) );
    SAFE_RELEASE( pBlobCS );
                                   ...
                                   ID3D11Buffer* pBaseVB )
{
    ...
    if ( s_pEdgeFactorCS == NULL )
    {
        ...
        V_RETURN( CompileShaderFromFile( L"TessellatorCS40_ScatterIDCS.hlsl", NULL, "CSScatterVertexTriIDIndexID", "cs_4_0", &pBlobCS ) );
        ...
        V_RETURN( CompileShaderFromFile( L"TessellatorCS40_ScatterIDCS.hlsl", NULL, "CSScatterIndexTriIDIndexID", "cs_4_0", &pBlobCS ) );
                       ...
                       UINT X, UINT Y, UINT Z )
{
    ...
    if ( pCBCS )
    {
        pd3dImmediateContext->UpdateSubresource(pCBCS, D3D11CalcSubresource(0, 0, 1), NULL, pCSData,
