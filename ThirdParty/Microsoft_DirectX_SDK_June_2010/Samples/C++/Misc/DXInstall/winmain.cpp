...
WCHAR g_strAppTitle[256];       // Application title
...
BOOL DirectXInstallInit( HINSTANCE hInstance )
{
    ...
    wndClass.lpszClassName = L"DirectXInstall";
                     ...
                     LPWSTR strCmdLine, int nCmdShow )
{
    ...
    HWND hWnd = CreateWindow( L"DirectXInstall", L"DirectX Install",
