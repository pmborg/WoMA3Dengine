...
//
// Comment out the following line to remove STL dependencies from this header.
//
#define ICONFIGDATABASE_USE_STL
...
//
// Typedef for pair of strings
//
typedef std::pair <std::string, std::string>    StringPair;

#endif // ICONFIGDATABASE_USE_STL
...
public:
    ...
    // CPU Speed is in MHz
    //
    virtual bool            Load( WCHAR* FileName,
    ...
    //
    virtual const std::vector <StringPair>& GetAggregateProperties() const = 0;
    virtual const std::vector <StringPair>* GetNamedProperties( const char* ) const = 0;
#endif
