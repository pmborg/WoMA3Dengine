...
//-----------------------------------------------------------------------------------------
// o/__   <-- BreakdancinBob TODO: Add the 'output' vertex to the VertexStream TriStream
// |  (\			           to amplify the geometry of the bar.
//
//                           HINT: To add a vertex to the output stream, use 
//                                 TriStream.Append(<vertex>). The type of the vertex 
//                                 depends on the template parameter for the stream, which 
//                                 in this case is VSStreamVertex.
//                           HINT: (Optional) We've made a helper function
//                                 float3 GetNormal(x,y,z) if you want to move geometry 
//                                 along the normals.
//-----------------------------------------------------------------------------------------

			}
			
			//We're done with the triangle
