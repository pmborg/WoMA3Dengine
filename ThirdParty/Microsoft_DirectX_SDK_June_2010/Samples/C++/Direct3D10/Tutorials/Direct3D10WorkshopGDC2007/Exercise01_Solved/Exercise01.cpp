...
INT WINAPI WinMain( HINSTANCE, HINSTANCE, LPSTR, int )
{
    ...
    DXUTCreateWindow( L"D3D10 Shader Model 4.0 Workshop GDC2007: Exercise01" );
                                      ...
                                      void* pUserContext )
{
    ...
    V_RETURN( DXUTFindDXSDKMediaFileCch( g_strEffect, MAX_PATH, L"Exercise01.fx" ) );
