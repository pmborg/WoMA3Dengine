...
#include "..\D3DWkshpPlugin\MemoryMapping.h"
...
bool                                g_bScreenEffects = true;
bool                                g_bFireworks = true;
...
INT WINAPI WinMain( HINSTANCE, HINSTANCE, LPSTR, int )
{
    ...
    DXUTCreateWindow( L"D3D10 Shader Model 4.0 Workshop GDC2007: Exercise06" );
...
void CALLBACK OnFrameMove( double fTime, float fElapsedTime, void* pUserContext )
{
    ...
    if( g_pSharedData )
    {
        g_pSharedData->Scaling = g_fScale;
        g_pSharedData->EffectLimit = g_fEffectLimit;
        g_pSharedData->EffectLife = g_fEffectLife;
        g_pSharedData->Normalization = g_fNormalization;
        g_pSharedData->UpdateFrequency = g_fSampleFrequency;
        g_pSharedData->StreamOut = g_bDrawFromStream ? 1 : 0;
        g_pSharedData->ScreenEffects = g_bScreenEffects ? 1 : 0;
        g_pSharedData->Fireworks = g_bFireworks ? 1 : 0;
    }
                                      ...
                                      void* pUserContext )
{
    ...
    V_RETURN( DXUTFindDXSDKMediaFileCch( g_strEffect, MAX_PATH, L"Exercise06.fx" ) );
