...
//-----------------------------------------------------------------------------------------
// o/__   <-- BreakdancinBob TODO: Create a new triangle with a velocity based on this one,
// |  (\			   with a lifespan so it fades away eventually.
//
//                           HINT: Add vertices to the output stream using 
//                                 TriStream.Append(float3). When you're done, call 
//                                 TriStream.RestartStrip() to end the triangle.
//                           HINT: g_fEffectLife holds the slider value for the effect's 
//                                 life.
