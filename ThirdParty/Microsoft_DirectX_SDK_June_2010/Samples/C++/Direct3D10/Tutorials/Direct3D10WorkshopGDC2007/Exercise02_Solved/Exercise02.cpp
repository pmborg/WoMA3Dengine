                                      ...
                                      void* pUserContext )
{
    ...
    V_RETURN( DXUTFindDXSDKMediaFileCch( g_strEffect, MAX_PATH, L"Exercise02.fx" ) );
...
void RenderMeshInstanced( ID3D10Device* pd3dDevice, ID3D10EffectTechnique* pTechnique )
{
    ...
    for( UINT p = 0; p < techDesc.Passes; ++p )
    {
        for( UINT subset = 0; subset < g_Mesh[0].GetNumSubsets( 0 ); ++subset )
        {
            ...
            pTechnique->GetPassByIndex( p )->Apply( 0 );
            //-----------------------------------------------------------------------------------------
            // o/__   Breakdancin' Bob TODO: Something's not right here...
            // |  (\    
            //-----------------------------------------------------------------------------------------

            //-----------------------------------------------------------------------------------------
            // Solution
            DXUT_BeginPerfEvent( DXUT_PERFEVENTCOLOR, L"Draw Bars" );
...
void CALLBACK OnD3D10FrameRender( ID3D10Device* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
    ...
    if( g_pEffect10 )
    {
        ...
        DXUT_BeginPerfEvent( DXUT_PERFEVENTCOLOR, L"Render Floor" );
        ...
        DXUT_BeginPerfEvent( DXUT_PERFEVENTCOLOR, L"Floor Effect RTT" );
        ...
        DXUT_BeginPerfEvent( DXUT_PERFEVENTCOLOR, L"Render Spectrogram" );
        ...
        DXUT_BeginPerfEvent( DXUT_PERFEVENTCOLOR, L"Do Fireworks" );
        ...
        DXUT_BeginPerfEvent( DXUT_PERFEVENTCOLOR, L"Full-Screen Effect" );
    ...
    DXUT_BeginPerfEvent( DXUT_PERFEVENTCOLOR, L"Render Spectrogram to Texture" );
