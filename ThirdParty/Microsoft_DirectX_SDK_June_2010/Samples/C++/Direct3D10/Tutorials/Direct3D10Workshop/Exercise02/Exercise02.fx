...
{	
	...
	//-----------------------------------------------------------------------------------------
	if( TriNormal.z < 0 ) 	// Test to make sure the normal is facing the camera (or the light)
	{
		PSSceneIn output;
		...
		for( uint i=0; i<6; i+=2 )
		{
			...
			//-----------------------------------------------------------------------------------------
			if ( AdjTriNormal.z >= 0 ) // Test to make sure the normal is NOT facing the camera (or the light)
			{
