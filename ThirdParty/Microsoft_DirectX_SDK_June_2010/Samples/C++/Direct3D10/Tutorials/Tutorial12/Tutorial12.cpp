...
//--------------------------------------------------------------------------------------
// DXUT Specific Global Variables
//--------------------------------------------------------------------------------------
                                      ...
                                      void* pUserContext )
{
    ...
    hr = D3DX10CreateShaderResourceViewFromFile( pd3dDevice, str, NULL, NULL, &g_pEnvMapSRV, NULL );
...
//--------------------------------------------------------------------------------------
// This callback function will be called immediately the swapchain has been resized.
// This is normally in response to the window being resized or the display settings
// being modified while in full screen mode.  This gives the application a chance to
// create objects that are dependent on the swap chain.
//--------------------------------------------------------------------------------------
HRESULT CALLBACK OnD3D10ResizedSwapChain( ID3D10Device* pd3dDevice, IDXGISwapChain* pSwapChain,
                                          const DXGI_SURFACE_DESC* pBufferSurfaceDesc, void* pUserContext )
{
...
//--------------------------------------------------------------------------------------
// This callback function will be to render a frame.  Presentation is taken care of by 
// DXUT now, so there is no present call in this function
//--------------------------------------------------------------------------------------
void CALLBACK OnD3D10FrameRender( ID3D10Device* pd3dDevice, double fTime, float fElapsedTime, void* pUserContext )
{
    //
