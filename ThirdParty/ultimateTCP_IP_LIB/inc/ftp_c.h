...
public:
	...
	virtual int		FTPConnect(CHAR* hostname, CHAR* userName = (CHAR*)"anonymous", CHAR* password = (CHAR*)"anonymous@anonymous.com", CHAR* account = (CHAR*)"");
#if defined _UNICODE
...
#else
	int				SendFileA(char* sourceFile, char* destFile)
		{return SendFile(sourceFile, destFile);};
#endif
