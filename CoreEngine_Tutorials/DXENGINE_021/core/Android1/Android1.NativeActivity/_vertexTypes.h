...
#if DX_ENGINE_LEVEL >= 23 // Diffuse Lighting
//	-------------------------------------------------------------------------------------------
...
#if DX_ENGINE_LEVEL >= 27//34 // Normal Bump
//	-------------------------------------------------------------------------------------------
...
#if DX_ENGINE_LEVEL >= 53 // ENGINE_LEVEL >= 66 //SHADER_Double_Color_Terrain
//	-------------------------------------------------------------------------------------------
...
#if DX_ENGINE_LEVEL >= 56 // ENGINE_LEVEL >= 71 //SHADER_Slope_Texture_Terrain_TexMapping
//	-------------------------------------------------------------------------------------------
