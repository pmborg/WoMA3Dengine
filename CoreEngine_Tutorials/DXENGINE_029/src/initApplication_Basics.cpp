...
void ApplicationClass::initIntroDemo()
{
	...
	INTRO_TEXT.push_back(TEXT("engine/data/banners/TEXT1 WoMA Muti-Platform Engine.png"));
	INTRO_TEXT.push_back(TEXT("engine/data/banners/TEXT2 is a Pmborg Production.png"));
	INTRO_TEXT.push_back(TEXT("engine/data/banners/TEXT3 WoMA Code By.png"));
	INTRO_TEXT.push_back(TEXT("engine/data/banners/TEXT4 Pedro Borges.png"));
	INTRO_TEXT.push_back(TEXT("engine/data/banners/TEXT5 Music By.png"));
	INTRO_TEXT.push_back(TEXT("engine/data/banners/TEXT6 Deceased Superior Technician.png"));
