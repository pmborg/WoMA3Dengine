...
//------------------------------------------------------------------------------------------------------------
	...
	//-------------------------------------------------------------------------------------------------------
			...
			#define USE_SKY_DOME				//we have sky in the world
			#define USE_SKYSPHERE				//the sky is a sphere
			#define USE_DIRECT_INPUT			// we will use DX input method
			#define ALLOW_PRINT_SCREEN_SAVE_PNG //print screen key will generate an image at DESKTOP
		#endif

		#if DX_ENGINE_LEVEL >= 29
			#define USE_SOUND_MANAGER	// SOUND: Sound Manager/"ogg" Loader
			#define USE_PLAY_MUSIC		// MUSIC: "ogg" Loader
			#define INTRO_DEMO			// Close the Intro / Demo of what was learned so far.
