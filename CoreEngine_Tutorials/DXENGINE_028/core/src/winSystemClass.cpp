...
//----------------------------------------------------------------------------
{
	...
	m_Application->g_NetID = (UINT)0; // Just Us on the world? So WE will be the index: zero...
	m_Application->SetPlayerPosition(m_Application->g_NetID);	// Step 6: SetPlayerPosition
