...
// ----------------------------------------------------------------------------
void DemoApplicationClass::initSky(float SPHERE_SIZE)
// ----------------------------------------------------------------------------
{
	...
	Textures.push_back(TEXT("engine/data/NEW_SKY_DOME.jpg"));	// L_20100319_360-panoramas_9781x1574_003.jpg
	...
	ASSERT(m_SkyModel->LoadLight(TEXT("m_SkyModel"), SystemHandle->m_Driver, SHADER_TEXTURE_LIGHT, &Textures, &Sphere_vertexdata, &Sphere_indexdata));
	m_SkyModel->PrimitiveTopology = TRIANGLESTRIP;
}

// ----------------------------------------------------------------------------
void DemoApplicationClass::CreateSphereModel(UINT SPHERE_SIZE, int Sphere_gridpoints)
// ----------------------------------------------------------------------------
{
