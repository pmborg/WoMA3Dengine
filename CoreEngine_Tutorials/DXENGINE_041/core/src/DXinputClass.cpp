...
void processSpecialKeys(int key, int x, int y) {
	...
	case GLUT_KEY_F1:
		...
		break;
	case GLUT_KEY_F2:
		DXsystemHandle->m_Input->m_keyboardState[DIK_F2] = 0x80;
		break;
	case GLUT_KEY_F3:
		DXsystemHandle->m_Input->m_keyboardState[DIK_F3] = 0x80;
		break;
	case GLUT_KEY_F4:
		DXsystemHandle->m_Input->m_keyboardState[DIK_F4] = 0x80;
		break;
	case GLUT_KEY_F5:
		DXsystemHandle->m_Input->m_keyboardState[DIK_F5] = 0x80;
		break;
	case GLUT_KEY_F6:
		DXsystemHandle->m_Input->m_keyboardState[DIK_F6] = 0x80;
		break;
	}
}
#endif
