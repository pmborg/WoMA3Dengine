...
void InitMeshDemo(ApplicationClass* app, MeshApplication* demoapp, MyDemo* demo)
{
    ...
    womamesh4[MAIN_CHAR_MODEL2].scene.lightManager
        .AddLight(dirLight)
        .AddLight(pointLight)
        .AddLight(spotLight)
        .SetGlobalAmbient(XMFLOAT4(0.1f, 0.1f, 0.1f, 1.0f));
    womamesh4[MAIN_CHAR_MODEL3].scene.lightManager
        .AddLight(dirLight)
        .AddLight(pointLight)
        .AddLight(spotLight)
        .SetGlobalAmbient(XMFLOAT4(0.1f, 0.1f, 0.1f, 1.0f));
    ...
    womamesh4[MAIN_CHAR_MODEL2].scene.Start(demoapp->m_Graphics);
    womamesh4[MAIN_CHAR_MODEL3].scene.Start(demoapp->m_Graphics);
}
void LoadAllMeshModels(UINT this_level, ApplicationClass* app, MeshApplication* demoapp, MyDemo* demo)
{
    ...
    womamesh4[MAIN_CHAR_MODEL2].assimpSceneModel = SceneModel::LoadModelToScene(DX_ENGINE_LEVEL, false, 2, WOMA::LoadFile((TCHAR*)TEXT("engine/data/scene87ForestHuntress/")), "", womamesh4[MAIN_CHAR_MODEL2].scene, demoapp->m_Graphics);
    womamesh4[MAIN_CHAR_MODEL3].assimpSceneModel = SceneModel::LoadModelToScene(DX_ENGINE_LEVEL, false, 3, WOMA::LoadFile((TCHAR*)TEXT("engine/data/scene87ForestHuntress/")), "", womamesh4[MAIN_CHAR_MODEL3].scene, demoapp->m_Graphics);
#endif
...
void RenderAllMeshModels(MeshApplication* demoapp, MyDemo* demo)
{
    ...
    // Model 4 ------------------------------------------------------------------------------------------
    {
        ...
        //Translate:
        const float X = 34, Z = 20;
        world.r[3].m128_f32[0] = X; //_41: X
        world.r[3].m128_f32[2] = Z; //_43: Z
        world.r[3].m128_f32[1] = mainTerrain->getTerrainHeight(TERRAIN_ID, world.r[3].m128_f32[0], world.r[3].m128_f32[2]);

        womamesh4[MAIN_CHAR_MODEL2].scene.UpdateWorldMatrixModel(demoapp->m_Graphics, world);
        demo->gBufferPass->Render(demoapp->m_Graphics, womamesh4[MAIN_CHAR_MODEL2].scene);
    }
        ...
        womamesh4[MAIN_CHAR_MODEL3].assimpSceneModel->loaded)
    {
        ...
        //Translate:
        const float X = 33, Z = 20;
        world.r[3].m128_f32[0] = X; //_41: X
        world.r[3].m128_f32[2] = Z; //_43: Z
        world.r[3].m128_f32[1] = mainTerrain->getTerrainHeight(TERRAIN_ID, world.r[3].m128_f32[0], world.r[3].m128_f32[2]);

        womamesh4[MAIN_CHAR_MODEL3].scene.UpdateWorldMatrixModel(demoapp->m_Graphics, world);
        demo->gBufferPass->Render(demoapp->m_Graphics, womamesh4[MAIN_CHAR_MODEL3].scene);
    }
#endif
}
