...
extern ID3D11ShaderResourceView* billboardAtlasSRV;  // One SRV for the entire atlas
extern std::vector<AtlasRegion> billboardAtlasRegions;  // UV regions for each billboard
#endif
...
public:
	...
	void Tree1GS(InstanceType* instances, int m_instanceCount);
#endif
