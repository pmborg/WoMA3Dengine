...
/*
    ...
    Shader Model 2.0 — Radeon 9500-9800/X300-X600, DirectX 9.							- Windows XP
    Shader Model 2.0a — GeForce FX/PCX-optimized model, DirectX 9.0a.					- Windows XP
    Shader Model 2.0b — Radeon X700-X850 shader model, DirectX 9.0b.					- Windows XP
    Shader Model 3.0 — Radeon X1000 and GeForce 6, DirectX 9.0c.						- Windows XP
    Shader Model 4.0 — Radeon HD 2000 and GeForce 8, DirectX 10.						- Windows VISTA
    Shader Model 4.1 — Radeon HD 3000 and GeForce 200, DirectX 10.1.					- Windows 8
    Shader Model 5.0 — Radeon HD 5000 and GeForce 400, DirectX 11. 						- Windows 10
    Shader Model 5.1 — GCN 1+, Fermi+, DirectX 12 (11_0+) with WDDM 2.0. 				- Windows 10
    Shader Model 6.0 — GCN 1+, Kepler+, DirectX 12 (11_0+) with WDDM 2.1. 				- Windows 10
    Shader Model 6.1 — GCN 1+, Kepler+, DirectX 12 (11_0+) with WDDM 2.3. 				- Windows 10
    Shader Model 6.2 — GCN 1+, Kepler+, DirectX 12 (11_0+) with WDDM 2.4. 				- Windows 10
    Shader Model 6.3 — GCN 1+, Kepler+, DirectX 12 (11_0+) with WDDM 2.5. 				- Windows 10
    Shader Model 6.4 — GCN 1+, Kepler+, Skylake+, DirectX 12 (11_0+) with WDDM 2.6. 	- Windows 10
    Shader Model 6.5 — GCN 1+, Kepler+, Skylake+, DirectX 12 (11_0+) with WDDM 2.7. 	- Windows 10
    Shader Model 6.6 — GCN 4+, Maxwell+, DirectX 12 (11_0+) with WDDM 3.0. 				- Windows 11
    Shader Model 6.7 — GCN 4+, Maxwell+, DirectX 12 (12_0+) with WDDM 3.1. 				- Windows 11
*/
