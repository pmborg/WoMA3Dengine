...
//#define CACHE_ALIGN __declspec(align(CACHE_LINE))
	...
	//vertex2
	ModelTextureLightVertexType vertex2 = {};											// Use this "VERTEX" on macro
	std::vector<ModelTextureLightVertexType> modelVertexVector2;						// Declare: the Vector with Vertex "TYPE"
