...
#if TUTORIAL_PRE_CHAP >= 41
void DXcameraClass::RenderReflection(float height)
{
	...
	lookAt = XMVectorSet( sinf(radians) + position.m128_f32[1], cosf(radians) + m_positionZ, 1.0f, 0.0f );
...
void DXcameraClass::GetReflectionViewMatrix(XMMATRIX& viewMatrix)
{
