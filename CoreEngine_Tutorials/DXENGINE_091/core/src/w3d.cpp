...
#pragma warning( pop )
	...
	bool DirectX::DXmodelClass::LoadW3DfromMEM(void* pContext, SHADER_TYPE shader_type, void* g_driver, STRING filename, bool castShadow, bool renderShadow, UINT instanceCount)
    {
        char* W3D_MEM_BUFFER=NULL;
        UINT W3D_MEM_BUFFER_SIZE=0;
		return extLoadW3DfromMEM(pContext, this, shader_type, g_driver, filename, castShadow, renderShadow, instanceCount);
    }
