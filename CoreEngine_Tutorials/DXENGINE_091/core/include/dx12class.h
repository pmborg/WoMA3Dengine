...
#if defined USE_VIEW2D_SPRITES || defined INTRO_DEMO || defined USE_RASTERTEK_TEXT_FONT
	// 2D
...
////////////////////////////////////////////////////////////////////////////////
	...
	void getProfile ();
	bool populateAllRasterizerStates (bool lineAntialiasing);
...
#endif
#if DX12_DXGI_API == 4
	ComPtr<IDXGIFactory4>		dxgiFactory;  // Create a DXGI 1.4 Interface (DEFAULT!)
#endif
#if DX12_DXGI_API == 5
...
//#endif
	...
	struct ThreadData
	{
		/*D3D12nBodyGravity*/ApplicationClass* pContext;
		UINT threadIndex;
	};
