...
#if   LEVEL >= 60
	Terrain60Textures.push_back(TERRAIN_SLOP_GRASS_TEXTURE);			//00
	Terrain60Textures.push_back(TERRAIN_SLOP_SLOPE_TEXTURE);			//01
	Terrain60Textures.push_back(TERRAIN_SLOP_ROCK_TEXTURE);				//02
	Terrain60Textures.push_back(TERRAIN_SLOP_DETAIL_TEXTURE);			//03
	Terrain60Textures.push_back(TERRAIN_SLOP_TEXTUREMAPPING_TEXTURE);	//04
	Terrain60Textures.push_back(TERRAIN_SLOP_SIDEWALK_TEXTURE);			//05
	Terrain60Textures.push_back(TERRAIN_SLOP_SAND_TEXTURE);				//06
	Terrain60Textures.push_back(TERRAIN_SLOP_MUD_TEXTURE);				//07
	Terrain60Textures.push_back(TERRAIN_SLOP_ALPHAMAPPING_TEXTURE);		//08
	Terrain60Textures.push_back(TERRAIN_SLOP_NORMAL_TEXTURE);			//09
	Terrain60Textures.push_back(TERRAIN_SLOP_SHADER_TEXTURE);			//10

	//Populate m_heightMap_21[index].b...g...r
	LoadColorMap(TERRAIN_SLOP_GRASS_TEXTURE);
#endif
...
#if   LEVEL >= 60
	ASSERT(SystemHandle->m_Application->m_TerrainModel[MAIN_TERRAIN_ID]->LoadTerrain(TEXT("Terrain 60"), m_Driver, SHADER_Terrain_Texture_DEMO60, &Terrain60Textures, &modelVertexVector2, &Terrain60indices));
#endif
