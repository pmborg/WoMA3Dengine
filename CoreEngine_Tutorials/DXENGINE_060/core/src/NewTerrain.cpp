...
#if   LEVEL >= 60
	ASSERT(SystemHandle->m_Application->m_Model[2]->LoadTerrain(TEXT("Terrain 60"), m_Driver, SHADER_Terrain_Texture_DEMO60, &Terrain60Textures, &modelVertexVector2, &Terrain60indices));
#endif
