...
copy /Y C:\WoMA3Dengine\HowTo\HowToInstallVisualStudio2022Community\VC_redist.x64.exe C:\WoMA3Dengine\CoreEngine_Tutorials\DXENGINE_029\output
@echo off

echo "Compiled:"
dir /S /B *.exe | find /v "fxc"
call \WoMA3Dengine\HowTo\HowToInstallWindows-InnoSetup\generate-installer-demo29.bat
pause