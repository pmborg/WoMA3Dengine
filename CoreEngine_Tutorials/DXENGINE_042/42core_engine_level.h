...
//------------------------------------------------------------------------------------------------------------
	...
	//-------------------------------------------------------------------------------------------------------
			...
			#define RENDER_MULTIPLE_TEXTURES	//31-
		#endif

		#if DX_ENGINE_LEVEL >= 32
			#define RENDER_OBJ_WITH_LIGHT	//32-
		#endif

		#if DX_ENGINE_LEVEL >= 33	//33-
			#undef DX12					//to be added later
			#define RENDER_OBJ_WITH_ALFA
		#endif

		#if DX_ENGINE_LEVEL >= 34	//34-
			...
			#define USE_LOADING_THREADS			//Use Thread to load Graphics
		#endif
		...
		#undef STANDALONE //This is a tutorial not a tool/converter
	#endif
