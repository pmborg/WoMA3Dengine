...
// ----------------------------------------------------------------------------------------------
{
	...
	*******************************************************************/
	...
	for (UINT mon = 0; mon < MonitorNumber; mon++)
	{
		...
		{
			#if CORE_ENGINE_LEVEL >= 10 && defined USE_SYSTEM_CHECK
  			{
		...
		DXGI_FORMAT allowedAdapterFormatArray [] = { DXGI_FORMAT_B8G8R8A8_UNORM, 
	...
	{
		WomaMessageBox(TEXT("Invalid uiMonitor number"), TEXT("Error: ")); 
		return false;
	}
