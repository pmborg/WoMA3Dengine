...
//-----------------------------------------------------------------------------------------	
{
	...
	SystemHandle->LoadAllGraphics();	// Load all main Graphics Objects, that will be rendered
...
//----------------------------------------------------------------------------
{
	...
	//if (WOMA::game_state <= GAME_MINIMIZED)
	{
		...
		default:
			SystemClass::LoadAllGraphics();	// (DX9 & Before Thread Support): [DX12] DXSample::Run OnInit();  LoadAssets();
			break;
		}
	}
