...
public:
	...
	virtual void RenderSky(UINT camera, float fadeLight = 1) = 0;
#endif
	...
	virtual bool LoadTerrain(TCHAR* objectName, void* driver, SHADER_TYPE shader_type, std::vector<STRING>* textureFile, std::vector<HeightMapType_24>* model, std::vector<UINT>* indexList = NULL, UINT instanceCount = 0) = 0;
#endif
