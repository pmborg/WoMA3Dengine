...
// ----------------------------------------------------------------------
	...
	bool SaveM3D	(STRING filename, void* indices, void* vertices, UINT sizeofMODELvertex);
	...
	std::vector<ModelNormalBumpVertexType>* modelNormalBumpVertex;		// MODEL!
	std::vector<ModelNormalBumpVertexType> modelNormalBumpVertex_;		// LOAD M3D
	bool InitializeTextureNormalBumpBuffers(void* g_driver, UINT* indices);

	std::vector<ModelShadowMapVertexType>* modelShadowMapVertex;		// MODEL!
	std::vector<ModelShadowMapVertexType> modelShadowMapVertex_;		// LOAD M3D
