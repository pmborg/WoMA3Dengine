...
// --------------------------------------------------------------------------------------------
	bool DXmodelClass::SaveW3D(STRING filename, void* indices, void* vertices, UINT sizeofMODELvertex)
	{
		...
		WOMA_LOGManager_DebugMSGAUTO(TEXT("W3D.min: %.1f %.1f %.1f\n"), W3D.min.x, W3D.min.y, W3D.min.z);
		WOMA_LOGManager_DebugMSGAUTO(TEXT("W3D.max: %.1f %.1f %.1f\n"), W3D.max.x, W3D.max.y, W3D.max.z);

		WOMA_LOGManager_DebugMSGAUTO(TEXT("W3D.verticesCount: %d\n"), W3D.verticesCount);
		WOMA_LOGManager_DebugMSGAUTO(TEXT("W3D.indicesCount: %d\n"), W3D.indicesCount);

		WOMA_LOGManager_DebugMSGAUTO(TEXT("W3D.materialCount: %d\n"), W3D.materialCount);
		WOMA_LOGManager_DebugMSGAUTO(TEXT("W3D.texturenameCount: %d\n"), W3D.texturenameCount);
		WOMA_LOGManager_DebugMSGAUTO(TEXT("W3D.meshSubsetIndexStartCount: %d\n"), W3D.meshSubsetIndexStartCount);
		WOMA_LOGManager_DebugMSGAUTO(TEXT("W3D.subsetMaterialArrayCount: %d\n"), W3D.subsetMaterialArrayCount);
#endif
