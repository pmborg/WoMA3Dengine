...
namespace WOMA
{
	...
	extern WOMA::vec3 vector3dCrossProduct (const WOMA::vec3 &vector1, const WOMA::vec3 &vector2);	// dont copy vectors!
	extern float vector3dLength(const WOMA::vec3 &v);										// dont copy vectors!
