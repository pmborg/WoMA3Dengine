...
// ----------------------------------------------------------------------------------------------
{
    ...
    result = m_device11->CreateRasterizerState(&rasterDesc, &m_rasterState[CULL_FRONT][FILL_SOLID]);
    IF_FAILED_RETURN_FALSE(result);

    rasterDesc.FillMode = D3D11_FILL_WIREFRAME;	//WIREFRAME
    result = m_device11->CreateRasterizerState(&rasterDesc, &m_rasterState[CULL_FRONT][FILL_WIRE]);
    IF_FAILED_RETURN_FALSE(result);
    ...
    rasterDesc.FillMode = D3D11_FILL_SOLID;		 //SOLID
    result = m_device11->CreateRasterizerState(&rasterDesc, &m_rasterState[CULL_BACK][FILL_SOLID]);
    IF_FAILED_RETURN_FALSE(result);

    rasterDesc.FillMode = D3D11_FILL_WIREFRAME;	//WIREFRAME
    result = m_device11->CreateRasterizerState(&rasterDesc, &m_rasterState[CULL_BACK][FILL_WIRE]);
    IF_FAILED_RETURN_FALSE(result);
    ...
    result = m_device11->CreateRasterizerState(&rasterDesc, &m_rasterState[CULL_NONE][FILL_SOLID]);
    IF_FAILED_RETURN_FALSE(result);

    rasterDesc.FillMode = D3D11_FILL_WIREFRAME;
    result = m_device11->CreateRasterizerState(&rasterDesc, &m_rasterState[CULL_NONE][FILL_WIRE]);
    IF_FAILED_RETURN_FALSE(result);
