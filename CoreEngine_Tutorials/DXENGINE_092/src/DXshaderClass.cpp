...
//NEW SHADER:
		...
		case SHADER_Terrain_Texture_DEMO61:
			...
			psFilename = vsFilename;
			vertexHLSL.append("MyVertexShader061terrain_fog_slope_detail_mapping");
			pixelHLSL.append("MyPixelShader061terrain_fog_slope_detail_mapping");
			break;
#endif
		case SHADER_FIRE:
			vsFilename.append(L"hlsl/072fire.hlsl");
			psFilename = vsFilename;
			vertexHLSL.append("MyVertexShader072fire");
			pixelHLSL.append("MyPixelShader072fire");
			break;
        case SHADER_TEXTURE_GS_INSTANCED:
            vsFilename.append(L"hlsl/077GSinstance.hlsl");
            psFilename = vsFilename;
            vertexHLSL.append("MyVertexShader077GS");
#if DX_ENGINE_LEVEL >= 90 && defined USE_OPTIMIZING
            gsHLSL.append("MyGSShader077GS");
            //bUseGS = true;
#endif
            pixelHLSL.append("MyPixelShader077GS");
            
            break;
        case SHADER_TEXTURE_LIGHT_FAST:
            vsFilename.append(L"hlsl/083Light.hlsl");
            psFilename = vsFilename;
            vertexHLSL.append("MyVertexShader083Light");
            pixelHLSL.append("MyPixelShader083Light");
            break;
